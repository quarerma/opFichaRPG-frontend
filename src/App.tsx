...
function App() {
  return (
    <div className="flex text-white font-bold font-oswald">
      <img src={bg} className="w-screen h-screen fixed z-0" />
      <div className="w-screen h-screen bg-black-filter opacity-[39%] fixed z-0" />
      <div className="absolute items-center flex flex-col top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
        ...
        <div className="bg-login-gray mt-10 w-[90%] flex items-center justify-center text-lg p-2 rounded-3xl gap-x-3 text-center">
